...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="💠Add Me💠",url="http://t.me/Fallen_angel_bot?startgroup=true"),InlineKeyboardButton(text="♻️Owner",url="https://t.me/thedevilreturns")]]
